...
import com.jiuye.baseframe.util.transformations.BlurTransformation;
import com.jiuye.baseframe.util.transformations.CropCircleTransformation;
import com.jiuye.baseframe.util.transformations.CropSquareTransformation;
import com.jiuye.baseframe.util.transformations.GrayscaleTransformation;
import com.jiuye.baseframe.util.transformations.RoundedCornersTransformation;
...
//                        .placeholder(R.drawable.ic_placeholder))
    ...
    public static void loadRoundedCorners(@NonNull Context context, @Nullable String string, @NonNull ImageView view,RoundedCornersTransformation.CornerType cornerType){
        Glide.with(context)
                .load(string)
                .apply(RequestOptions.bitmapTransform(new RoundedCornersTransformation(20, 0,cornerType)))
                .into(view);
    }
